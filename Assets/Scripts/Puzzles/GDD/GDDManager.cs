...
public class GDDManager : MonoBehaviour
{
    ...
    public void CollectBinder()
    {
        ...
        Log("Game Design Document acquired! You can now collect and review design pages in order to get out of the maze.");
    }
    ...
    public void CollectPage(PuzzleData data)
    {
        ...
        Log(string.IsNullOrEmpty(data.pageTitle)
            ? "Design page recovered. Check it before the next intersection."
